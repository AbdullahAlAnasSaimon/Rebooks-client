  ...
  return (
    <div>
      <footer className="footer p-10 bg-blue-500 text-white">
        <div>
          <span className="footer-title opacity-100 text-gray-300">Categories</span>
          <Link className="link link-hover" to='/category'>Action and Adventure</Link>
          <Link className="link link-hover" to='/category'>Classic</Link>
          <Link className="link link-hover" to='/category'>Graphic Novel</Link>
          <Link className="link link-hover" to='/category'>Fantasy</Link>
        </div>
        <div>
          <span className="footer-title opacity-100 text-gray-300">Authentication</span>
        ...
        <div>
          <span className="footer-title opacity-100 text-gray-300">Legal</span>
