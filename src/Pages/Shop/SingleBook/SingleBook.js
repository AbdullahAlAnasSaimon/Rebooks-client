...
const SingleBook = ({book}) => {
  console.log(book);
  const {name, condition, description, loacation, original_price, phone_number, photo, posting_time, resell_price, seller_email, seller_name, year_of_purchase, year_of_use} = book;
  return (
