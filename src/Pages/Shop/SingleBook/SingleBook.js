...
const SingleBook = ({ books, setBookData }) => {
  const { name, verified, condition, description, location, original_price, phone_number, photo, posting_time, resell_price, seller_name, year_of_purchase, year_of_use, paid } = books;
          ...
          <div className="card card-side bg-base-100 shadow-xl flex-col-reverse md:flex-row">
            <div className="card-body">
              ...
              <div className="card-actions justify-start">
                ...
                <button onClick={() => handleReportItem(books._id)} className='btn btn-warning'><MdReport className='inline-block mr-1' /> Report to Admin</button>
              </div>
            </div>
